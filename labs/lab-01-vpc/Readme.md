...
⚠️ **IMPORTANTE - COSTOS:**
- **Elastic IP sin usar cuesta ~$3.60 USD/mes** ($0.005/hora)
- **NAT Gateway cuesta ~$32 USD/mes** ($0.045/hora) + data transfer
- **SIEMPRE ejecuta la limpieza después del lab** para evitar cargos inesperados
...
# 2. Eliminar NAT Gateway (IMPORTANTE: esperar a que se elimine)
aws ec2 delete-nat-gateway --nat-gateway-id $NAT_GW_ID
echo "Esperando que NAT Gateway se elimine completamente..."
sleep 90  # NAT Gateway tarda ~2 minutos en eliminarse

# 3. Liberar Elastic IP (CRÍTICO: solo después de eliminar NAT Gateway)
