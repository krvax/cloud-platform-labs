...
# Fix encoding para terminales que no soportan emojis
...
def generate(n_lines: int, output_path: str):
    ...
    print(f"\n[OK]  Generadas {n_lines} lineas en '{output_path}'")
    ...
    print(f"[t]  Latencia: avg={sum(latencies)//len(latencies)}ms  p95={p95}ms  p99={p99}ms")
