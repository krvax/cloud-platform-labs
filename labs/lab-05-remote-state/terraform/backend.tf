...
# -----------------------------------------------------------------------------
# INSTRUCCIONES:
# 1. Comenta este bloque entero en el primer apply (bootstrap con state local)
# 2. Reemplaza <YOUR_ACCOUNT_ID> con el output de: terraform output state_bucket_name
# 3. Descomenta y corre: terraform init -migrate-state
# -----------------------------------------------------------------------------
