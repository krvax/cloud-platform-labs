...
- **⬅️ Anterior:** [04-cicd-concepts.md](./04-cicd-concepts.md) — CI/CD
- **➡️ Siguiente:** [06-scripting-coding-prep.md](./06-scripting-coding-prep.md) — Scripting
...
- **[Lab 07 — Prometheus + Grafana en EKS](../labs/lab-07-monitoring/Readme.md)**
  - Instalar kube-prometheus-stack con Helm
  - Crear dashboards de golden signals
  - Configurar alertas con Alertmanager
  - Practicar PromQL para SLOs y burn rates

- **[Lab 09 — CloudWatch Logs](../labs/lab-09-cloudwatch-logs/Readme.md)**
  - EC2 con generador de logs JSON
  - CloudWatch Agent para centralización
  - Metric Filters y Alarmas
  - CloudWatch Logs Insights queries

- **[Lab Scripting — log_analyzer.py](../labs/scripting/README.md)**
  - Análisis de logs con Python
  - Cálculo de SLO y error budget
