...
- **⬅️ Anterior:** [05-observability-concepts.md](./05-observability-concepts.md) — Observabilidad
- **➡️ Siguiente:** [07-kubernetes-deep-dive.md](./07-kubernetes-deep-dive.md) — Kubernetes profundo
...
- **[Lab Scripting — 11 Mock Exercises](../labs/scripting/README.md)**
  - 11 ejercicios de scripting (Python + Bash)
  - Análisis de logs con SLO check
  - Warmup exercises (20 min)
  - Bonus practice (12 ejercicios adicionales)
